...
public class Simulator{
   ...
   // Generates interarrival times 
    ...
    public double generateJobs(double p1, double mew3, double mew4){
    ...
    public double simulate(double lambda1,double p, double mew1, double mew2){
        ...
        nextArrival = currentTime + interArrivalTimes();
         ...
         */
            if(nextArrival < nextDeparture){
                ...
                //with probability p generate job sizes X = exp(mew1) and with probability 1-p X = exp(mew1)
                jobSizeToAdd = generateJobs(p, mew1, mew2);
